...
var BlockIdentifiers = mapset.NewThreadUnsafeSet(sliceutil.FlatMap([]string{
	"acacia_button",
	"acacia_door",
	"acacia_double_slab",
	"acacia_fence",
...
var ItemIdentifiers = mapset.NewThreadUnsafeSet(sliceutil.FlatMap([]string{
	"acacia_boat",
	"acacia_button",
	"acacia_chest_boat",
	"acacia_door",
...
var EntityIdentifiers = mapset.NewThreadUnsafeSet(sliceutil.FlatMap([]string{
	"agent",
	"allay",
	"area_effect_cloud",
	"armadillo",
...
var ParticleIdentifiers = mapset.NewThreadUnsafeSet(
